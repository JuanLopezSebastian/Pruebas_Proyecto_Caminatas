...
public class ComentarioController {
    ...
    public boolean usuarioParticipo(Long idUsuario, Long idCaminata) {
        return I_InscripcionUsuarioRepository.existsByUsuarioIdAndCaminataId(idUsuario, idCaminata);
    }
