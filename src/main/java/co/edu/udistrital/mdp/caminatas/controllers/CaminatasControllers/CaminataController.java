...
public class CaminataController {
    ...
    @PostMapping
    public ResponseEntity<CaminataResponseDTO> create(@Valid @RequestBody CaminataDTO dto) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CaminataResponseDTO> update(@PathVariable Long id, @Valid @RequestBody CaminataDTO dto) {
